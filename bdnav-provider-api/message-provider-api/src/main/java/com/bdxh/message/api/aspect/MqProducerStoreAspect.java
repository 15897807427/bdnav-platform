...
import com.bdxh.message.api.annotation.MqProducerStore;
import com.bdxh.message.api.model.domain.MqMessageData;
import com.bdxh.message.api.model.enums.DelayLevelEnum;
...
public class MqProducerStoreAspect {
	 ...
	 */
	@Pointcut("@annotation(com.bdxh.message.api.annotation.MqProducerStore)")
