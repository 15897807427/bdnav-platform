...
package com.bdxh.message.api.aspect;

import com.bdxh.common.base.enums.ErrorCodeEnum;
import com.bdxh.message.api.annotation.MqConsumerStore;
...
public class MqConsumerStoreAspect {
	 ...
	 */
	@Pointcut("@annotation(com.bdxh.message.api.annotation.MqConsumerStore)")
	...
	public Object processMqConsumerStoreJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		if (args == null || args.length == 0) {
			throw new TaskBizException(ErrorCodeEnum.TPC10050005);
		}

		if (!(args[0] instanceof List)) {
			throw new TaskBizException(ErrorCodeEnum.GL99990001);
		}
	...
	private MqMessageData getTpcMqMessageDto(MessageExt messageExt) {
		...
		data.setMessageType(MqMessageTypeEnum.CONSUMER_MESSAGE.getMessageType());
		return data;
	}
}
