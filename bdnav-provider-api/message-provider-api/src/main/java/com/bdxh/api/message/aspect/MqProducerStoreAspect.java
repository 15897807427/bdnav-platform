...
package com.bdxh.api.message.aspect;

import com.bdxh.api.message.annotation.MqProducerStore;
import com.bdxh.api.message.model.domain.MqMessageData;
import com.bdxh.api.message.model.enums.DelayLevelEnum;
...
public class MqProducerStoreAspect {
	 ...
	 */
	@Pointcut("@annotation(com.bdxh.api.message.annotation.MqProducerStore)")
