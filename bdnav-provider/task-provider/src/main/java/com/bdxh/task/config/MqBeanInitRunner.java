...
import com.bdxh.common.zk.registry.base.ReliableMessageRegisterDto;
import com.bdxh.task.listener.MqConsumerChangeListener;
import com.bdxh.task.listener.MqProducerChangeListener;
import com.bdxh.task.service.MqProducerBeanFactory;
import com.bdxh.task.service.TpcMqProducerService;
...
public class MqBeanInitRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		CoordinatorRegistryCenter coordinatorRegistryCenter = RegistryCenterFactory.createCoordinatorRegistryCenter(globalProperties.getZk());
