/*
 * Copyright (c) 2018. bdnav.net All Rights Reserved.
 * 项目名称：bdnav快速搭建企业级分布式微服务平台
 * 类名称：OAuth2FeignAutoConfiguration.java
 * 创建人：刘兆明
 * 联系方式：bdnav.net@gmail.com
 * 开源地址: https://github.com/bdnav
 * 博客地址: http://blog.bdnav.net
 * 项目官网: http://bdnav.net
 */

package com.bdxh.common.feigin.feign;
...
public class OAuth2FeignAutoConfiguration {
	 ...
	 */
	@Bean("bdnavClientCredentialsResourceDetails")
	 ...
	 */
	@Bean
	public RequestInterceptor oauth2FeignRequestInterceptor(@Qualifier("bdnavOAuth2RestTemplate") OAuth2RestTemplate oAuth2RestTemplate) {
